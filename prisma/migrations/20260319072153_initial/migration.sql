...
-- CreateIndex
CREATE INDEX "Post_state_updatedAt_idx" ON "Post"("state", "updatedAt" DESC);

-- CreateIndex
CREATE INDEX "Post_category_state_createdAt_idx" ON "Post"("category", "state", "createdAt" DESC);

-- CreateIndex
CREATE INDEX "Post_authorId_state_updatedAt_idx" ON "Post"("authorId", "state", "updatedAt" DESC);

-- CreateIndex
CREATE INDEX "Post_authorId_createdAt_idx" ON "Post"("authorId", "createdAt" DESC);

-- CreateIndex
CREATE INDEX "Post_accessKey_idx" ON "Post"("accessKey");
